...
def create_overview_figure(aggregated, protocol_order):
    fig = make_subplots(
        rows=1,
        cols=3,
        subplot_titles=("Handshake Latency", "Large File Throughput", "Multi-Object Total Time"),
    )
    metric_frames = {
    ...
    for col_index, metric in enumerate(["ttfb", "throughput", "total_time"], start=1):
