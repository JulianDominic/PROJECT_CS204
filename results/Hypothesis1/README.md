...
Local Testing: We performed a handshake test under baseline scenarios and found that Gopher (Original) and HTTP/3 presented the lowest TTFB out of all the protocols we tested. 
...
Remote Testing: We performed a handshake test under baseline scenarios and found that HTTP/3 achieved the best performance for 1kb.txt, while Gopher (Modern) achieved the best performance for 1mb.txt
