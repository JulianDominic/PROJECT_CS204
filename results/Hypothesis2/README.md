# Hypothesis 2: HTTP/1.1 achieves the highest throughput for bulk transfers

## Local Testing

![Throughput 1MB - Local](./throughput_1mb_local.png)
...
![Throughput 1MB - Remote](./throughput_1mb_remote.png)
